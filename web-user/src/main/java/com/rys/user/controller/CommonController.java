...
public class CommonController {
    ...
    @Anonymous
    public Result<PageInfoResponse<Therapist>> getAllTherapists(PherapistQueryRequest pherapistQueryRequest) {
        PageInfoResponse<Therapist> therapistPageInfoResponse = therapistService.allTherapists(pherapistQueryRequest);
    ...
    public Result delTherapist(@RequestBody @Validated IdReq idReq) {
        therapistService.removeById(idReq.getId());
        return Result.success();
    }
