...
public class SessionServiceImpl extends ServiceImpl<SessionMapper, Session> implements SessionService {
    ...
    public PageInfoResponse<SessionResp> listSession(SessionQueryReq sessionQueryReq, Integer roleType) {
        ...
        List<SessionResp> resps = records.stream().map(e -> {
            ...
            sessionResp.setUserName(userMap.get(e.getUserId()).getName());
            sessionResp.setTherapistName(therapistMap.get(e.getTherapistId()).getName());
            sessionResp.setPhone(userMap.get(e.getUserId()).getPhone());
            return sessionResp;
