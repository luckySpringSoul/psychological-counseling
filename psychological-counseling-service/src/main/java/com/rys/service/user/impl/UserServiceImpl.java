...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public Result<LoginResponse> getUserByPhone(LoginRequest loginRequest) {
        ...
        if (!Objects.equals(AesUtils.encrypt(loginRequest.getPassword()), user.getPassword())) {
    ...
    public void addUser(AddUserRequest addUserRequest) {
        ...
        user.setPassword(AesUtils.encrypt(addUserRequest.getPassword()));
        ...
        user.setRoleType(addUserRequest.getRoleType());
    ...
    public void editUser(AddUserRequest addUserRequest) {
        ...
        User exist = this.getById(addUserRequest.getId());
        if (Objects.nonNull(exist) && !exist.getPhone().equals(addUserRequest.getPhone())) {
            User judge = lambdaQuery().eq(User::getPhone, addUserRequest.getPhone())
                .eq(User::getRoleType, addUserRequest.getRoleType()).last("limit 1").one();
    ...
    private LambdaQueryWrapper<User> buildQueryWrapper(UserQueryReq userQueryReq) {
        ...
        queryWrapper.eq(Objects.nonNull(userQueryReq.getRoleType()), User::getRoleType, userQueryReq.getRoleType());
        return queryWrapper;
    }
